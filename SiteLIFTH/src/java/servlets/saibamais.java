 ...
 * @author root
 */
@WebServlet(name = "saibamais", urlPatterns = {"/saibamais.do"})
public class saibamais extends HttpServlet {
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
           ...
           try {
               integ = dao.consultarI(request.getParameter("nome"));
           } catch (SQLException e) {
                e.printStackTrace();
           }
           
           request.setAttribute("integ", integ);
